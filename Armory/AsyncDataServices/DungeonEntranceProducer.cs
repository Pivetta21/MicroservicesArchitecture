...
public class DungeonEntranceProducer : RabbitMqProducerBase, IRabbitMqProducer<DungeonEntranceArmoryDto>
{
    ...
    public void Publish(DungeonEntranceArmoryDto @event, SagaInfo sagaInfo)
    {
    ...
    public void Publish(DungeonEntranceArmoryDto @event, IBasicProperties props)
    {
        try
        {
    ...
    private void LogInformation(DungeonEntranceArmoryDto @event, IBasicProperties props)
    {
    ...
    private void LogError(DungeonEntranceArmoryDto @event, Exception ex, IBasicProperties props)
    {
        _logger.LogError(
            ex,
